...
class DeployAction(AbstractAction):
  def _fill_in_subparser(self, sub_parser: ArgumentParser):
    ...
    sub_parser.add_argument("-t", "--target_directory", dest="target_directory", default=os.getcwd(), help="path to the target directory (should not exist or be empty)")
    sub_parser.add_argument("-z", "--do_zip", dest="do_zip", action="store_true",
