...
class CleanAction(AbstractAction):
  def _fill_in_subparser(self, sub_parser: ArgumentParser):
    ...
    sub_parser.add_argument("-w", "--working_directory", dest="working_directory", help="path to the working directory", default=getcwd())
    sub_parser.add_argument("-t", "--target_directory", dest="target_directory", help="path to target directory to clean", default=getcwd())
    sub_parser.add_argument("--env-folder-name", dest="env_folder_name", help="name of the environment variables folder", default="envs")
    sub_parser.add_argument("--config-folder-name", dest="config_folder_name", help="name of the configs folder", default="configs")
  ...
  def run(self, namespace):
    ...
    if os.path.normpath(namespace.working_directory) == os.path.normpath(namespace.target_directory):
    ...
    deployment.clean_files(namespace.target_directory)